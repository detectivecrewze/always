...
async function main() {
  ...
  // Add intro titles
  giftData.introPreTitle = 'a letter for you';
  giftData.introHeadline1 = 'Happy';
  giftData.introHeadline2 = 'Birthday,';
  giftData.introHeadline3 = 'Baby Inesta';

  console.log('Saving updated gift data...');
  await cfSet(`gift:${kvId}`, giftData);
  await cfSet(`draft:${kvId}`, giftData);

  console.log(`✅ Done! Added intro title for ${kvId}.`);
}
